...
import 'package:usa/est/Les%20Chutes%20du%20Niagara.dart';
import 'package:usa/est/Great%20Smoky%20Mountains.dart';
import 'package:usa/est/Parc de Shenandoah.dart';
import 'package:usa/est/Voyageurs%20National%20Park.dart';
...
class _EstPageState extends State<EstPage> {
  ...
  // FORCE STRICTEMENT L'UTILISATION DE LA CLE 'favoris_fr' POUR L'EST
  final String _frenchFavoritesKey = 'favoris_fr';

  // Liste complète des destinations de l'Est (Aucune modification ni suppression, tout en français)
  final List<Map<String, dynamic>> destinations = [
    {
      'nom': 'Les Chutes du Niagara',
      'image': 'assets/images/109.jpg',
      'desc': 'Trois chutes d\'eau monumentales à la frontière canadienne, un spectacle de puissance et de brume.',
      'couleur': Colors.blue.shade400,
      'lieu': 'New York, USA',
      'sosie': 'Chutes d\'Iguazu, Brésil / Argentine',
      'page': const NiagaraFallsPage(title: 'Les Chutes du Niagara')
    },
    {
      'nom': 'Great Smoky Mountains',
      'image': 'assets/images/111.webp',
      'desc': 'Une brume bleue caractéristique s\'élevant au-dessus des crêtes de l\'un des plus vieux massifs montagneux au monde.',
      'couleur': Colors.teal.shade300,
      'lieu': 'North Carolina / Tennessee, USA',
      'sosie': 'Forêt de Daintree, Australie',
      'page': const GreatSmokyMountainsPage(title: 'Great Smoky Mountains')
    },
    {
      'nom': 'Parc de Shenandoah',
      'image': 'assets/images/122.webp',
      'desc': 'Un havre sauvage traversé par la Skyline Drive, offrant des vues à couper le souffle sur la vallée de Shenandoah.',
      'couleur': Colors.green.shade400,
      'lieu': 'Virginie, USA',
      'sosie': 'Parc National des Cévennes, France',
      'page': const ShenandoahParkPage(title: 'Parc de Shenandoah')
    },
    {
      'nom': 'Voyageurs National Park',
      'image': 'assets/images/128.webp',
      'desc': 'Un labyrinthe aquatique de lacs et de canaux forestiers préservés, idéal pour l\'aventure et le canoë.',
      'couleur': Colors.cyan.shade300,
      'lieu': 'Minnesota, USA',
      'sosie': 'Région des lacs de Saimaa, Finlande',
  ...
  Future<void> _loadFavorites() async {
    ...
    setState(() {
      _favoritedNames = prefs.getStringList(_frenchFavoritesKey) ?? [];
    });
  }
  ...
  Future<void> _toggleFavorite(String name) async {
    ...
    await prefs.setStringList(_frenchFavoritesKey, _favoritedNames);
  }
  ...
  // METHODE DE NAVIGATION STRICTEMENT CARTES
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      // Désactivation de toutes les animations de clic et ondes
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            isShowingFavorites ? 'Mes Favoris' : 'Est Américain',
  ...
  // FAVORIS SIMPLIFIÉS AVEC NOUVEAU REFLET LUMINEUX
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          // Ombre profonde pour le contraste
          BoxShadow(
